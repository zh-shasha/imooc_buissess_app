package com.etoury.robot.utils;
...
import com.etoury.robot.R;

public class CEditText extends androidx.appcompat.widget.AppCompatEditText {

    private int height = 60;//view的高度

    private int count = 4;//矩形数目
    ...
    private int lineColor = Color.GRAY; //边框颜色
    private int stokesColor =Color.GRAY;//填充颜色
    private int st=R.mipmap.iv_psd_input;

    private int st1=R.mipmap.iv_psd_input;
    private int focusStokeColor =Color.GRAY; //焦点填充颜色
    private int focusLineColor =Color.GRAY;  //焦点边框颜色
    ...
    public CEditText(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            focusStokeColor = typedArray.getColor(R.styleable.CEditText_focusStokeColor, st1);
            stokesColor = typedArray.getColor(R.styleable.CEditText_stokesColor, st);
